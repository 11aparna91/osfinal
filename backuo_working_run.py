...
if __name__ == '__main__':
    ...
    project_id = "graphite-willow-363021"
    location = "us-west2"
    cluster_name = "cluster-node-"
    bst = BinarySearchTree()
    bst.insert(3)
    print("Creating Cluster")
    create_cluster(project_id , location, cluster_name+"3") 
    bst.insert(1)
    print("Creating Cluster")
    create_cluster(project_id , location, cluster_name+"1")
    print("Creating Cluster")
    # bst.insert(2)
    # create_cluster(project_id , location, cluster_name+"2") 
    bst.print()
    bst.delete_node(bst.get_root(), 2)
    delete_cluster(project_id ,location, cluster_name+"2") 
    ...
    # create_cluster(project_id , location, cluster_name) 